...
TOPIC = [PROXYVERIFICATE_TOPIC,'jd_task_kind','Crawl_getproxi_es_js']#本地想要执行的任务列表

INSTALL_MOUDEL=('pymongo' ,'platform','psutil','multiprocessing','motor','aiohttp','asyncio','flask','pyquery')#客户端依赖的所有第三方库
...
GET_THREADING_COUNT= 50 #开启的槽位个数，建议合理设置内部使用进程实现
